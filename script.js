...
btnScrollTo.forEach(btn =>
  btn.addEventListener('click', function (e) {
    ...
    const btnClicked = e.target.getAttribute('id');

    if (btnClicked === 'scroll-cta') {
      const ctaCoords = ctaSection.getBoundingClientRect();
      ctaSection.scrollIntoView({ behavior: 'smooth' });
    } else if (btnClicked === 'scroll-features') {
...
///////////////////////////////////////
// Slider before swiper
// I use swiper to add touch slide on mobile.
